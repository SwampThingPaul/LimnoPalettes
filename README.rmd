...
#im=load.image("./images/lewis_lakes_clipped.jpg")

par(family="serif",mar=c(0,0,0,0))
layout(matrix(1:3,3,1),heights=c(1,1,0.25))
plot(im,ann=F,axes=F,rescale=F)
...
### AbiskoSed1
```{r AbiskoSed1 ,fig.height=5,fig.width=7,align='center',echo=FALSE,message=FALSE,warning=FALSE}
im=load.image("./images/Abisko_SBurnet.jpeg")
#im=load.image("./images/lewis_lakes_clipped.jpg")

par(family="serif",mar=c(0,0,0,0))
layout(matrix(1:3,3,1),heights=c(1,1,0.25))
plot(im,ann=F,axes=F,rescale=F)
print(limno_palette("AbiskoSed1"),cex=2)
plot(0:1,0:1,ann=F,axes=F,type="n")
text(0,0.5,"Photo Credit: Sarah Burnet (Twitter: limnosarah)",adj=0)
```

### AbiskoSed2
```{r AbiskoSed2 ,fig.height=5,fig.width=7,align='center',echo=FALSE,message=FALSE,warning=FALSE}
im=load.image("./images/Abisko2_SBurnet.jpeg")
#im=load.image("./images/lewis_lakes_clipped.jpg")

par(family="serif",mar=c(0,0,0,0))
layout(matrix(1:3,3,1),heights=c(1,1,0.25))
plot(im,ann=F,axes=F,rescale=F)
print(limno_palette("AbiskoSed2"),cex=2)
plot(0:1,0:1,ann=F,axes=F,type="n")
text(0,0.5,"Photo Credit: Sarah Burnet (Twitter: limnosarah)",adj=0)
```
